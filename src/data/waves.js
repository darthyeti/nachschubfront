// The complete wave list (GDD section 9, "Wellenaufbau").
//
// Generated by tests/tools/make-waves.mjs (`npm run waves`): five-wave cycle
// horde, armour, air, warp, mixed, every tenth wave a boss with escort.
...
export const WAVES = [
  // Wave 1 · horde · 30 enemies
  { kind: 'horde', scale: 1, groups: [
    { type: 'swarmer', count: 26, interval: 0.4, delay: 0 },
    { type: 'warrior', count: 4, interval: 0.8, delay: 2 },
  ] },
  // Wave 2 · armour · 12 enemies
  { kind: 'armour', scale: 1.12, groups: [
    { type: 'breaker', count: 5, interval: 1.5, delay: 0 },
    { type: 'warrior', count: 7, interval: 0.8, delay: 2 },
  ] },
  // Wave 3 · air · 20 enemies
  { kind: 'air', scale: 1.2544, groups: [
    { type: 'carrionflyer', count: 14, interval: 0.8, delay: 0 },
    { type: 'warrior', count: 6, interval: 0.8, delay: 2 },
  ] },
  // Wave 4 · warp · 14 enemies
  { kind: 'warp', scale: 1.4049, groups: [
    { type: 'warpseer', count: 8, interval: 1.1, delay: 0 },
    { type: 'warrior', count: 6, interval: 0.8, delay: 2 },
  ] },
  // Wave 5 · mixed · 28 enemies
  { kind: 'mixed', scale: 1.5735, groups: [
    ...
    { type: 'carrionflyer', count: 4, interval: 0.8, delay: 6 },
    { type: 'warpseer', count: 3, interval: 1.1, delay: 8 },
  ] },
